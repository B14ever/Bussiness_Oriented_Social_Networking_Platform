...
import {Box, Typography,Divider,Avatar,LinearProgress,
   Button,Dialog,DialogActions,DialogContent,DialogTitle,Snackbar,Alert,Backdrop,CircularProgress,IconButton, TextField} from '@mui/material'
...
const Jobs = () => {
  ...
  useEffect(() => {
    ...
    try{
     setLoading(true)
     const responce = await axios.get('/vacanices')
